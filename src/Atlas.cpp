...
void InitAtlasCoord() {
    ...
    const int y[eLAST] = {0,   0,   0,   0,   0,   0, //eWheel
                          64,  64,  128, 160, 160, 160, 313, 259, 259, 64,  64, 140, 364, 364, 364, 517,
                          463, 463, 592, 784, 976, 123, 441, 551, 111, 221, 1,  331, 771, 826, 661, 716};
    const int w[eLAST] = {24, 24, 24,  24, 24, 24,  12,  12,  238, 238, 41,  41,  320, 40,  40,  12,  12,  238, 238,
                          41, 41, 320, 40, 40, 235, 235, 235, 235, 400, 400, 400, 400, 400, 400, 400, 400, 400, 400};
    const int h[eLAST] = {56,  56, 56,  56,  56, 56, 8,  8,  8,  16, 153, 153, 47, 101, 101, 8,  8,  8, 16, 153,
                          153, 47, 101, 101, 35, 35, 35, 35, 98, 98, 98,  98,  98, 98,  48,  48, 48, 48
